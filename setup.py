...
version_file = 'mmdet/version.py'#修改地方1
...
"""
    sha = get_hash()
    with open('mmdet/VERSION', 'r') as f:#修改地方2
...
if __name__ == '__main__':
    ...
    setup(
        ...
        llicense='Apache License 2.0',
        setup_requires=parse_requirements('/content/gdrive/MyDrive/OBBDetection bishe/requirements'),
        tests_require=parse_requirements('/content/gdrive/MyDrive/OBBDetection bishe/requirements/tests.txt'),
        install_requires=parse_requirements('/content/gdrive/MyDrive/OBBDetection bishe/requirements/runtime.txt'),
        extras_require={
            'all': parse_requirements('requirements.txt'),
            'tests': parse_requirements('/content/gdrive/MyDrive/OBBDetection bishe/requirements/tests.txt'),
            'build': parse_requirements('/content/gdrive/MyDrive/OBBDetection bishe/requirements/build.txt'),
            'optional': parse_requirements('/content/gdrive/MyDrive/OBBDetection bishe/requirements/optional.txt'),
        },
        ext_modules=[
            make_cuda_ext(
                name='compiling_info',
